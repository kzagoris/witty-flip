...
describe("blog integration", () => {
  ...
  describe("sitemap includes blog URLs", () => {
    it("includes /blog and valid blog post URLs in sitemap XML", async () => {
      ...
      expect(xml).toContain("<loc>https://wittyflip.com/image-converter</loc>")
      expect(xml).toContain("<loc>https://wittyflip.com/privacy</loc>")
      expect(xml).not.toContain("<loc>https://wittyflip.com/png-to-jpg</loc>")
    })
  })
})
