...
const CONVERSION_TYPES = [
  ...
  },
  {
    ...
    faq: [
      ...
      { question: 'Is it safe to convert HTML files?', answer: 'Yes. Our converter runs in a sandboxed environment with no network access, preventing any external resource loading or SSRF attacks.' },
    ],
